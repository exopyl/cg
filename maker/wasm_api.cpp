...
//   exportObj(id)  -> delegue a MeshIO::export_obj, materiaux et .mtl
...
std::string meshToObj(Mesh* m)
{
    ...
    std::string obj = "# generated by maker\n";
...
// serialisation du moteur natif (MeshIO::export_obj), qui ecrit aussi le .mtl compagnon.
//
...
// les tests d'E/S du moteur natif.

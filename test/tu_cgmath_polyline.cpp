...
#include "../src/cgmath/polyline.h"

TEST(TEST_cgmath_polyline, Init)
{
	ProfilePolyline curve;
...
TEST(TEST_cgmath_polyline, SetPosition)
{
	ProfilePolyline curve;
	curve.init(3);
...
TEST(TEST_cgmath_polyline, SetPositionOutOfRange)
{
	ProfilePolyline curve;
	curve.init(3);
...
TEST(TEST_cgmath_polyline, SetPositionNegativeIndex)
{
	ProfilePolyline curve;
	curve.init(3);
...
TEST(TEST_cgmath_polyline, SetPositionNotInitialized)
{
	ProfilePolyline curve;
...
TEST(TEST_cgmath_polyline, InverseOrder)
{
	ProfilePolyline curve;
	curve.init(3);
...
TEST(TEST_cgmath_polyline, GenerateSurfaceRevolution)
{
	ProfilePolyline curve;
	curve.init(3);
	curve.set_position(0, 1.f, 0.f, 0.f);
...
TEST(TEST_cgmath_polyline, GenerateFrame)
{
	ProfilePolyline curve;
	curve.init(2);
...
TEST(TEST_cgmath_polyline, ReInit)
{
	ProfilePolyline curve;
	curve.init(3);

...
float fSample6(float fX, float fY, float fZ)
{
	...
	vec3f sp[8] = {
		{r, 0.f, 0.f},
		{r*cos(45.f*3.14159f/180.f), r*sin(45.f*3.14159f/180.f), 0.f},
		{0.f, r, 0.f},
		{r*cos(135.f*3.14159f/180.f), r*sin(135.f*3.14159f/180.f), 0.f},
		{-r, 0.f, 0.f},
		{r*cos(225.f*3.14159f/180.f), r*sin(225.f*3.14159f/180.f), 0.f},
		{0.f, -r, 0.f},
		{r*cos(315.f*3.14159f/180.f), r*sin(315.f*3.14159f/180.f), 0.f}
	};

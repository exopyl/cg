...
/*     ------------------------------------------------------------------ */
/* Subroutine */ int nnls_(doublereal *a,
							integer *mda, const integer *m, const integer *n,
							doublereal *b, doublereal *x, doublereal *rnorm,
							doublereal *w, doublereal *zz,
							integer *index, integer *mode)
{
    ...
    /* Local variables */
    extern doublereal diff_(doublereal *x, doublereal *y);
    static integer iter;
    static doublereal temp, wmax;
    static integer i__, j, l;
    static doublereal t, alpha, asave;
    static integer itmax, izmax, nsetp;
    extern /* Subroutine */ int g1_(doublereal *a, doublereal *b, doublereal *cterm, doublereal *sterm, doublereal *sig);
    static doublereal dummy, unorm, ztest, cc;
	extern /* Subroutine */ int h12_(integer *mode, integer *lpivot, integer *l1, const integer *m,
...
/*     ------------------------------------------------------------------ */
/* Subroutine */ int h12_(integer *mode, integer *lpivot, integer *l1, const integer *m,
						doublereal *u, integer *iue, doublereal *up, doublereal *c__,
						integer *ice, integer *icv, integer *ncv)
{
    /* System generated locals */
...
/* The following subroutine was added after the f2c translation */
int nnls_c(double* a, int* mda, const int* m, const int* n, double* b, 

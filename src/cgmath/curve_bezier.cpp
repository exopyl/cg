...
/**
* compute nPoints along the B�zier curve
*
* /return 1 if the new control point is correctly added, 0 otherwise
*/
int
...
/**
* compute nPoints along the B�zier curve (quadratic curve, ie 3 control points, ie degree = 2)
*
* /return 1 if the new control point is correctly added, 0 otherwise
*/
int
...
/**
* compute nPoints along the B�zier curve (cubic curve, ie 4 control points, ie degree = 3)
*
* /return 1 if the new control point is correctly added, 0 otherwise
*/
int
